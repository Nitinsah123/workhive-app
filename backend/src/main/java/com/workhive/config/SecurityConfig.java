...
import com.workhive.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/invitations/accept/**", "/api/invitations/accept").permitAll()
                .requestMatchers("/api/invitations/token/**").permitAll()
                .requestMatchers("/api/email-connections/gmail/callback").permitAll()
